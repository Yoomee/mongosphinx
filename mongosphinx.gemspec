...
Gem::Specification.new do |spec|
  ...
  spec.files = ["README.rdoc", "lib/mongo_sphinx.rb", "lib/mongo_sphinx/tasks.rb","lib/mongo_sphinx/configuration.rb","lib/mongo_sphinx/multi_attribute.rb", "lib/mongo_sphinx/mixins/properties.rb", "lib/mongo_sphinx/mixins/indexer.rb", "lib/mongo_sphinx/indexer.rb"]
  spec.require_path = "."
  spec.has_rdoc = true
  spec.executables = []
